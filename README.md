...
Added downloading comments in everything, added downloading all subtitles (useful to search media by text), removed the watch scripts (use the original project for downloading specifically to watch), simplified the directory structure.
